...
/****** Object:  Database [studentsDB]    Script Date: 31-3-2015 12:33:47 ******/
CREATE DATABASE [studentsDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'studentsDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SYNSERNET\MSSQL\DATA\studentsDB.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'studentsDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SYNSERNET\MSSQL\DATA\studentsDB_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
